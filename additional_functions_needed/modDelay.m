% MODDELAY
% This function creates a series delay effect using a buffer.
% The delay time can be modulated based on the LFO parameters
% "depth" and "rate".
%
% Input Variables
...
% depth : raneg of modulation (sampels)
...
% Store the current output in appropiate index
buffer(indexC,1) = in;
